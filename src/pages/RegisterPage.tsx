          ...
          <div className="space-y-4 pt-4">
            <div className="p-4 bg-secondary/50 rounded-xl">
              <p className="text-sm text-muted-foreground mb-2">
                <strong className="text-white">{t('secret.userCode')}</strong>
              </p>
              <code className="text-sm bg-background px-3 py-2 rounded-lg block text-green-400">
                TELEGRAM_INTELLIGENCE_2024_SECURE_ACCESS
              </code>
            </div>
            <div className="p-4 bg-secondary/50 rounded-xl">
              <p className="text-sm text-muted-foreground mb-2">
                <strong className="text-white">{t('secret.adminCode')}</strong>
              </p>
              <code className="text-sm bg-background px-3 py-2 rounded-lg block text-yellow-400">
                TELEGRAM_INTELLIGENCE_2024_ADMIN_SUPER_ACCESS
              </code>
            </div>
            <p className="text-xs text-muted-foreground/60">
              {t('secret.adminFeatures')}
            </p>
          </div>
        </DialogContent>
      </Dialog>
